...
基于Vue+SpringBoot+MySQL的**学生日常行为评分管理系统**，包含项目全部源码、数据库脚本、功能文档、开题报告、文献综述、PPT，您可以在https://bbs.csdn.net/topics/616321446中预览本资源的全部内容，项目编号S010。 

学生日常行为评分管理系统包含**评分项目模块、评分数据模块**，还包含系统自带的**用户管理、部门管理、角色管理、菜单管理、日志管理、数据字典管理、文件管理、图表展示**等基础模块，学生日常行为评分管理系统基于角色的访问控制，给学生、教师、管理员使用，可将权限精确到按钮级别，您可以自定义角色并分配权限，系统适合设计精确的权限约束需求。 

高分毕业设计项目，也可作为课程设计、大作业，下载即可使用，无需修改，确保可以直接运行（免费手把手启动教学课程：https://edu.csdn.net/course/detail/38632），主要针对计算机相关专业的正在做毕设的学生和需要项目实战的Java学习者，也可作为课程设计、期末大作业。
...
| 链接说明      | 对应地址                                                  |
| ------------- | --------------------------------------------------------- |
| 全套项目下载  | <https://download.csdn.net/download/qq_41464123/87961922> |
| 文档/答疑讨论 | https://bbs.csdn.net/topics/616321446                     |
| B录屏预览     | <[https://www.bilibili.com/video/BV1S14y1z73A>            |
